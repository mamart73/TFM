...
categoricas <- c(
  ...
  'age1stbaby.21orLess','age1stbaby.22orMore','age1stbaby.NA',
  'sleeptrouble.Yes','tvhrsday.0to1hr','tvhrsday.2to3hr',
  ...
  'alcoholday.NA','smokenow.No','smokenow.Yes','smoke100.No',
...
#¡¡¡¡¡ESTO SOLO FUNCIONA CON METRICA ACCURACY!!!!!
results <- rfe(x, y, sizes=c(50:55), rfeControl=control)
#sizes=k tamaño de los subconjuntos de variables input en los cuales se
...
length(selecrfe)
#108 variables con k=50:55 con metrica por defecto
# dput(selecrfe)
# c("age", "totchol", "urineflow1", "height", "weight", "urinevol1",
...
#Las 5 variables mas importantes de arboles son:
# age         totchol  healthgen.Fair          weight healthgen.Vgood 
# 1263.42991       323.97250       179.73626       125.13257        35.03561 
#Las 5 variables mas importantes son 
#age, totchol, healthgen.Fair, weight y healthgen.Vgood

#Las 5 variables mas importantes de random forest son:
#age, totchol, weight, healthgen.Fair y height

#-----3. Algunas conclusiones-----

#AIC selecciona 52 variables
#BIC selecciona 23 variables
#SBF selecciona 95 vaariables
#RFE selecciona 108 variables, es decir, todas las input
#Boruta selecciona 108 variables, es decir, todas las input
#(RFE y Boruta son iguales)
#SES y MMPC seleccionan las mismas variables (16 variables)
#Arbol y Random forest nos quedamos con las 5 más relevantes (entre ellas
#difieren en una unica variable)
